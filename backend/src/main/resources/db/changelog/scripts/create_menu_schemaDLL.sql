...
CREATE TABLE menu_schema.CATEGORY_SUBMENU(
	CATEGORY_ID VARCHAR(36) NOT NULL,
	SUBMENU_ID VARCHAR(36) NOT NULL,
	UNIQUE KEY CATEGORY_SUBMENU_ID (CATEGORY_ID,SUBMENU_ID),
	CONSTRAINT FK_CATEGORY_SUBMENU_CATEGORY_ID FOREIGN KEY (CATEGORY_ID) REFERENCES CATEGORY(ID),
	CONSTRAINT FK_CATEGORY_SUBMENU_SUBMENU_ID FOREIGN KEY (SUBMENU_ID) REFERENCES SUBMENU(ID) ON DELETE CASCADE
);